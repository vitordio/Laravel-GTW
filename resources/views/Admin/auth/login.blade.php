                ...
                <div class="container h-100">
                    <div class="row no-gutters h-100 align-items-center">
                        <div class="col-md-8 col-lg-7 col-xl-6 mx-auto">
                            <h2>@lang('labels.loginTitle')</h2>
                            <p class="m-b-30">@lang('labels.messageCredentials')</p>
                            <form method="POST" action="{{ route('login') }}" data-grecaptcha-action="login">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <a class="float-right font-size-13 text-muted" href="{{ route('formForgotPassword') }}">@lang('labels.esqueceu_a_senha')</a>
