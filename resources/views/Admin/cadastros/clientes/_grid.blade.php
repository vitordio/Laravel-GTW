    ...
    <table id="ajax-data-table" class="table">
        <thead>
            <tr>
                ...
                @canany(['VisualizarClientes', 'EditarClientes', 'ExcluirClientes'])
    ...
    <script>
        $(document).ready(function() {
            ...
            .then(dadosModelo => {
                ...
                {
                    serverSide: true,
                    ajax: "{{ route('clientes.ajaxDataTable', ['idModelo' => isset($modeloSelecionado) ? $modeloSelecionado->id : $modeloPadrao->id ]) }}",
                    columns: arrColunas,
                    searching: true,
                    paging: true,
                    sort: true,
