<div class="page-header no-gutters has-tab">
    <div class="d-md-flex m-b-15 align-items-center justify-content-between">
        ...
        <div class="m-b-15">
            @can('EditarClientes')
                <a href="{{ route('clientes.edit', ['cliente' => Crypt::encryptString($model->id)]) }}" class="m-r-5 button-edit p-v-10 p-h-20" title="@lang('labels.edit')" data-toggle="tooltip" data-placement="top">
            ...
            @can('ExcluirClientes')
                <a class="delete-button button-delete p-v-10 p-h-20 m-r-15"
                    data-name="{{ $model->des_nome }}" data-id="{{ $model->id }}" data-method="DELETE" data-item="@lang('labels.cliente')"
                    title="@lang('labels.delete')" data-toggle="tooltip" data-placement="top"
                    href="{{ route('clientes.destroy', ['cliente' => Crypt::encryptString($model->id)]) }}"> 
        ...
        <div class="col-md-9">
            <div>
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#emailsAlternativos-cliente">@lang('labels.emailsAlternativos')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#coletas-cliente">@lang('labels.coletas')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#entregas-cliente">@lang('labels.entregas')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#faturas-cliente">@lang('labels.faturas')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#negociacoes-cliente">@lang('labels.negociacoes')</a>
                    </li>
                </ul>
                <div class="tab-content m-t-15 p-25">
                    <div class="tab-pane fade show active" id="emailsAlternativos-cliente">
                        <ul class="timeline">
                            @forelse ($model->emailsAlternativos as $email)
                                <li class="timeline-item">
                                    <div class="timeline-item-head">
                                        <div class="avatar avatar-icon bg-white">
                                            <i class="anticon anticon-mail font-size-22 text-dark"></i>
                                        </div>
                                    </div>
                                    <div class="timeline-item-content">
                                        <div class="m-l-10">
                                            <h5 class="m-b-5">{{ $email->des_email }}</h5>
                                        </div>
                                    </div>
                                </li>
                            @empty
                                <p>Nenhum e-mail alternativo cadastrado.</p>
                            @endforelse
                        </ul>

                    </div>
                    <div class="tab-pane fade" id="coletas-cliente">
                        <p></p>
                    </div>
                    <div class="tab-pane fade" id="entregas-cliente">
                        <p></p>
                    </div>
                    <div class="tab-pane fade" id="faturas-cliente">
                        <p></p>
                    </div>
                    <div class="tab-pane fade" id="negociacoes-cliente">
                        <p></p>
                    </div>
                </div>
            </div>
