    ...
    <table id="ajax-data-table" class="table">
        <thead>
            <tr>
                ...
                <th>@lang('labels.des_atividade')</th>
                <th>@lang('labels.flg_ativo')</th>
                @canany(['VisualizarTipoAtividade', 'EditarTipoAtividade', 'ExcluirTipoAtividade'])
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            const arrColunas = [
                { data: 'id', name: 'id' },
                { data: 'des_atividade', name: 'des_atividade' },
            ...
            {
                serverSide: true,
                ajax: "{{ route('tipoAtividade.ajaxDataTable') }}",
                columns: arrColunas,
                searching: true,
                paging: true,
                sort: true,
