                            ...
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between m-b-30">
                                        ...
                                        <h4 class="m-b-0">@lang('labels.resetPassword')</h4>
                                    </div>
                                    
                                    <p class="m-b-30">@lang('labels.messageResetPassword')</p>

                                    <form method="POST" action="{{ route('clienteResetPassword') }}" data-grecaptcha-action="resetPassword">
                                        {{ csrf_field() }}
                                        <div class="form-group">
                                            <label class="font-weight-semibold" for="des_login">@lang('labels.des_login')</label>
                                            <div class="input-affix">
                                                <i class="prefix-icon anticon anticon-user {{ $errors->has('des_login') || Session::has('message') ? 'is-invalid' : '' }}"></i>
                                                <input type="text" name="des_login" value="{{ old('des_login') }}" class="form-control {{ $errors->has('des_login') || Session::has('message') ? 'is-invalid' : '' }}" id="des_login" placeholder="@lang('labels.des_login')">
