    ...
    <div class="nav-wrap">
        ...
        @if(env('AMBIENTE') === Biblioteca::AMBIENTE_DSV)
            <div class="nav-center d-flex align-content-center align-items-center">
                <h2 class="text-danger font-weight-bold">AMBIENTE DE DESENVOLVIMENTO - ÁREA DO CLIENTE</h2>
            </div>
        @endif
                    ...
                    <div class="p-h-20 p-b-15 m-b-10 border-bottom">
                        <div class="d-flex m-r-50">
                            ...
                            <div class="m-l-10">
                                ...
                                <p class="m-b-0 opacity-07">{{ Auth::user()->des_login }}</p>
                            </div>
                        </div>
                    </div>

                    <a href="javascript:void(0);" id="btn-logout" date-route="{{ route('clienteLogout') }}" class="dropdown-item d-block p-h-15 p-v-10">
