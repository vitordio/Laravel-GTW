...
<head>
    ...
    <title>{{ config('app.name') }} - {{ trans('titles.permissaoNegada') }}</title>
                ...
                <div class="row">
                    <div class="container">
                        <div class="row align-items-center align-center">
                            <div class="col-md-12">
                                <div class="p-v-30">
                                    <h1 class="font-weight-semibold display-1 text-primary lh-1-2">@lang('messages.codigoErroPermissaoNegada')</h1>
                                    <h2 class="font-weight-light font-size-30">@lang('messages.permissaoNegada')</h2>
                                    <p class="lead m-b-30">@lang('messages.textPermissaoNegada')</p>
                                    @if(Auth::user()) <a href="{{ url()->previous() }}" class="btn btn-primary btn-tone">@lang('labels.back')</a> @endif
                                </div>
                            </div>
                        </div>
                    </div>
